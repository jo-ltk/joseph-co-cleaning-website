        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 md:items-center">
          {plans.map((plan, index) => (
            <motion.div
              ...
              className={`relative flex flex-col rounded-[24px] md:rounded-[32px] overflow-hidden border border-aztec/5 transition-all duration-500 ${plan.popular ? "bg-aztec text-white py-8 md:py-12 shadow-[0_40px_100px_rgba(0,0,0,0.2)] md:scale-105 z-10" : "bg-white text-aztec py-7 md:py-10 shadow-[0_20px_50px_rgba(0,0,0,0.04)]"}`}
            >
              <div className="px-6 md:px-10">
                ...
                <Button variant={plan.popular ? "primary" : "secondary"}
                  className={`w-full h-11 md:h-12 rounded-full text-sm font-bold transition-all duration-300 ${plan.popular ? "bg-yellow-green text-aztec hover:bg-white" : "bg-transparent border border-aztec/10 text-aztec hover:bg-aztec/5"}`}>
                  Select Plan
                </Button>
              </div>
